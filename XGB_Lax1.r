...
# XGBoost Model Tuning - Women's Lacrosse
...
save(test, file = "lax1_run_test.rda")
...
save(prelim_importance, bst_split_pred_data_pre_tune, 
     pred_viz_pre_tune, diff_hist_pre_tune, file = "lax1_pre_tune_files.rda")
...
save(res_db, bst_max_depth, bst_min_child, g_2, 
     file = "lax1_min_child_max_depth.rda")
...
save(res_db, bst_col_samp, bst_sub_samp, g_4, 
     file = "lax1_sample_colsample.rda")
...
lax1_full_preds_df <- rbind(bst_split_pred_data_pre_tune, bst_pred_data)
