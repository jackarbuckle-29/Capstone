...
soc1_data$position_name <- as.numeric(revalue(soc1_data$position_name, 
        c("Forward"=3, "Midfield"=2, "Center Back" = 1,
          "Striker"=3, "Keeper" = 0, "Outside Back" = 1,
          "Center Midfield"=2, "Defender"=1, "Midfielder" = 2, 
          "Goal Keeper"=0, "Defensive Midfielder"=2, "Central Midfielder"=2,
          "Attacking Midfielder"=2, "Centre Back"=1, "Utility"=2, 
          "Wing"=5, "Back"=1, "Wide"=5)))
...
# write.csv(lax0_data,"G:\\Shared drives\\Analytics Capstone\\R Project - Analytics Capstone\\Exported_CSVs\\lax0_data_cleaned.csv",row.names=FALSE)
# 
# write.csv(lax1_data,"G:\\Shared drives\\Analytics Capstone\\R Project - Analytics Capstone\\Exported_CSVs\\lax1_data_cleaned.csv",row.names=FALSE)

write.csv(soc0_data,"G:\\Shared drives\\Analytics Capstone\\R Project - Analytics Capstone\\Exported_CSVs\\soc0_data_cleaned_up_pos.csv",row.names=FALSE)

write.csv(soc1_data,"G:\\Shared drives\\Analytics Capstone\\R Project - Analytics Capstone\\Exported_CSVs\\soc1_data_cleaned_up_pos.csv",row.names=FALSE)
